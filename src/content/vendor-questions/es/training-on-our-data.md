---
title: Entrenamiento con nuestros datos
locale: es
number: 1
order: 1
...
Una respuesta real separa los dos casos y los nombra: ningún contenido del cliente se
usa para entrenar nuestros modelos, ningún contenido del cliente se comparte con otra
empresa para desarrollar modelos, y aquí está la cláusula del contrato que lo dice. Una
respuesta real también le dice qué cambia si usted activa cierta función.

Una evasiva contesta solo la segunda mitad. «Nunca vendemos sus datos» y «no compartimos
datos con terceros» dejan intacto el entrenamiento interno de la propia empresa, que es
justo el hueco que deja la regla federal. Lo mismo pasa con «los datos solo se usan para
mejorar el servicio», que es una descripción del entrenamiento, no una negación.

Anote la respuesta, el nombre y el cargo de quien se la dio, y la fecha. Si la respuesta
es sí bajo cualquier condición, pregunte qué formulario de consentimiento lo cubre y pida
una copia.
