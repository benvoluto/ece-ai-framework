---
title: Identificadores biométricos
locale: es
number: 2
order: 2
...
Una respuesta real nombra la función y la técnica: el etiquetado automático de fotos
calcula una plantilla facial, o la entrada y salida compara una cara con una plantilla
guardada, o nada en el producto calcula plantillas de ningún tipo. También debe decir
dónde se guarda la plantilla, cuánto tiempo se conserva y si usted puede apagar la
función por completo.

Una evasiva habla de fotografías en vez de plantillas. «No hacemos reconocimiento facial»
no es lo mismo que «no calculamos geometría facial»: agrupar las fotos de un niño según
quién sale en ellas requiere una plantilla, se llame como se llame en el mercadeo.
«Búsqueda por voz» y «etiquetado inteligente» son las frases sobre las que hay que
insistir.

Si la respuesta es sí, esto necesita un consentimiento parental separado, específico y
revocable antes de que un solo niño quede inscrito en la función, no una línea en el
manual.
